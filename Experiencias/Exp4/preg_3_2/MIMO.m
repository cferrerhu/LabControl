...
% ci(3) = ci_mod(2);
% 
% s = [ 'Escalón [\phi \theta]: [' num2str(stepp) ']' newline 'Condiciones iniciales [\phi \theta]: [' num2str(ci_mod) ']']
% 
% %% 3.2.2
% lgd_fs = 24;
% axis_fs = 20;
...
% ylabel('Ángulo [\pi rad]','FontSize',axis_fs)
% 
% 
...
% title('Simulación en lazo abierto')
% 
% 
% 
% %%
...
title('Simulación en lazo abierto','FontSize',lgd_fs)
...
title('Simulación en lazo abierto sistema linealizado','FontSize',lgd_fs)

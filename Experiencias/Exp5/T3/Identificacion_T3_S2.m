...
% tiempo = 20*60; % tiempo a simular (sin transiente inicial)
% Ts = 0.01; % frec sampleo
% cant_escalones = 10; % cantidad de pert en el tiempo
% DC = 15; % Valor de la entrada a la que se suman las pert
% pert = 3; % ancho de las perturbaciones ej. randi([-pert pert])
% trans_inicial = 200; % transiente inicial en segundos

tiempo = 20*60; % tiempo a simular (sin transiente inicial)
Ts = 0.01; % frec sampleo
cant_escalones = 15; % cantidad de pert en el tiempo
DC = 15; % Valor de la entrada a la que se suman las pert
pert = 3; % ancho de las perturbaciones ej. randi([-pert pert])
trans_inicial = 400; % transiente inicial en segundos
...
%%
sim('s_tanks_3_LA.slx', length(entrada)*Ts)
...
saveas(gcf,['C:\Users\cristobal\Desktop\U\11 semestre\Lab_Cont\LabControl\Experiencias\Exp5\T' tanque_n '\fotos\Iden_T' tanque_n '_2.png']);
% close
%%
...
xlabel('Tiempo [s]','FontSize',axis_fs)
ylabel('Altura [cm]','FontSize',axis_fs)
lgd = legend({'Referencia T2' 'Respuesta T1' 'Respuesta T2'});
lgd.FontSize = lgd_fs;
...
saveas(gcf,['C:\Users\cristobal\Desktop\U\11 semestre\Lab_Cont\LabControl\Experiencias\Exp5\T' tanque_n '\fotos\CL_T' tanque_n '_2.png']);
...
saveas(gcf,['C:\Users\cristobal\Desktop\U\11 semestre\Lab_Cont\LabControl\Experiencias\Exp5\T' tanque_n '\fotos\CLN_T' tanque_n '_2.png']);

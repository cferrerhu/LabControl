% D_TANKS_3
%
% Control Lab: LQR design of a PI-plus-feedforward, and proportional controller
% for the Coupled-Tank system in Configuration #3.
%
% D_TANKS_3 designs an inner proportional controller for the Tank 1 level loop,
% and an outer feedforward-plus-PI controller for the Tank 2 level loop.
% D_TANKS_3 returns the corresponding gains: Kp_1, Ki_1, Kp_2, Ki_2
%
% Copyright (C) 2010 Quanser Consulting Inc.
% Quanser Consulting Inc.

% Configuration #3: Tank 2 Level Control
